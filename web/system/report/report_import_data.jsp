    ...
    function report_data_today() {
        $.ajax({
            ...
            url: "controller.report_data?today"
                ...
                setTimeout(function() {
                    $("#content").load('controller.report_data?show_print_today');
                }, 3000);
    ...
    function report_summary_today() {
        $.ajax({
            ...
            url: "controller.report_summary?today"
                ...
                //  alert("บันทึกการขายแล้ว");
                setTimeout(function() {
                    $("#content").load('controller.report_summary?show_print_today');
                }, 3000);
    ...
    function report_data_day() {
        $.ajax({
            ...
            url: "controller.report_data?day"
                ...
                //  alert("บันทึกการขายแล้ว");
                setTimeout(function() {
                    $("#content").load('controller.report_data?show_print_day');
                }, 3000);
    ...
    function report_summary_day() {
        $.ajax({
            ...
            url: "controller.report_summary?day"
                ...
                //  alert("บันทึกการขายแล้ว");
                setTimeout(function() {
                    $("#content").load('controller.report_summary?show_print_day');
                }, 3000);
    ...
    function report_data_month() {
        $.ajax({
            ...
            success: function() {
                //  alert("บันทึกการขายแล้ว");
                setTimeout(function() {
                    $("#content").load('controller.report_data?show_print_month');
                }, 3000);
    ...
    function report_summary_month() {
        $.ajax({
            ...
            url: "controller.report_summary?month"
                ...
                setTimeout(function() {
                    $("#content").load('controller.report_summary?show_print_month');
                }, 3000);
    ...
    function report_data_year() {
        $.ajax({
            ...
            url: "controller.report_data?year"
                    , success: function() {
                setTimeout(function() {
                    $("#content").load('controller.report_data?show_print_year');
                }, 3000);
    ...
    function report_summary_year() {
        $.ajax({
            ...
            url: "controller.report_summary?year"
                ...
                //  alert("บันทึกการขายแล้ว");
                setTimeout(function() {
                    $("#content").load('controller.report_summary?show_print_year');
                }, 3000);
    ...
    function report_data_employee() {
        ...
        $.ajax({
            ...
            url: "controller.report_data?employee"
                ...
                //  alert("บันทึกการขายแล้ว");
                setTimeout(function() {
                    $("#content").load('controller.report_data?show_print_employee');
                }, 3000);
    ...
    function report_data_customer() {
        ...
        $.ajax({
            ...
            url: "controller.report_data?customer"
                ...
                //  alert("บันทึกการขายแล้ว");
                setTimeout(function() {
                    $("#content").load('controller.report_data?show_print_customer');
                }, 3000);
    ...
    function report_data_product() {
        $.ajax({
            ...
            url: "controller.report_data?product"
                ...
                //  alert("บันทึกการขายแล้ว");
                setTimeout(function() {
                    $("#content").load('controller.report_data?show_print_product');
                }, 3000);
    ...
    function report_data_type() {
        $.ajax({
            ...
            url: "controller.report_data?type"
                ...
                //  alert("บันทึกการขายแล้ว");
                setTimeout(function() {
                    $("#content").load('controller.report_data?show_print_type');
                }, 3000);
...
<form id="report">
    ...
    <table>
        ...
        <tr>
            ...
            <td>&nbsp;&nbsp;ระหว่าง &nbsp;<input type="text" name="date_start" id="date_start" class="input-mini" style="padding: 5px;width: 100px;font-size: 15px ;margin: 3px ;  height: 35px" >
                &nbsp;ถึง &nbsp;<input type="text" name="date_end" id="date_end" class="input-mini" style="padding: 5px;width: 100px;font-size: 15px ;margin: 3px ; height: 35px" >
